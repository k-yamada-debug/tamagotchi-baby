...
export const LIFE_STAGES: LifeStageConfig[] = [
  {
    ...
    depletionRates: { hunger: 5, cleanliness: 5, mood: 3, energy: 4 },
  },
  {
    id: 'infant',
    label: '乳児',
    ...
    depletionRates: { hunger: 4, cleanliness: 6, mood: 4, energy: 4 },
  },
  {
    id: 'toddler',
    label: '幼児',
    ...
    depletionRates: { hunger: 3, cleanliness: 7, mood: 5, energy: 5 },
  },
  {
    id: 'preschooler',
    label: '園児',
    ...
    availableActions: ['feed', 'diaper', 'sleep', 'bathe', 'play', 'walk', 'read'],
    depletionRates: { hunger: 3, cleanliness: 5, mood: 6, energy: 6 },
  },
  {
    id: 'elementary',
    label: '小学生',
    ...
    depletionRates: { hunger: 2, cleanliness: 4, mood: 5, energy: 5 },
  },
  {
    id: 'middleSchool',
    label: '中学生',
    ...
    availableActions: ['feed', 'sleep', 'bathe', 'play', 'walk', 'read'],
    depletionRates: { hunger: 2, cleanliness: 3, mood: 6, energy: 4 },
  },
];
